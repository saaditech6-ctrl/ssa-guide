import { Calculator, ArrowLeft, BookOpen, ShieldAlert, Sparkles, ChevronRight, ExternalLink } from "lucide-react"
import Link from "next/link"

export const metadata = {
  title: "Social Security Benefit Taxation Guide 2026",
  description: "Are your Social Security benefits taxable? Learn the income thresholds, how much you may owe, and 10 legal strategies to reduce your tax bill.",
}
...
const sections = [
  ...
  {
    title: "Strategy 3 — Qualified Charitable Distributions",
      ...
      <div className="bg-gradient-to-br from-[#071530] via-[#0b2045] to-[#102e60] py-14 text-white">
        <div className="container-site max-w-5xl mx-auto px-4">
          ...
          <p className="text-slate-400 text-[11px] font-medium tracking-wide mt-6">
            By Amine Saadi · Updated June 2026 · 9 min read
          </p>
        </div>
      </div>

      {/* محتوى المقال مع الشريط الجانبي التجاوبي */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <article className="lg:col-span-2 space-y-6">
            <div className="bg-white border border-slate-200/60 rounded-2xl p-6 sm:p-8 shadow-sm prose-article">
              ...
              {/* صندوق فكرة وملاحظة سريعة في بداية المقال */}
              ...
              {/* معالجة وعرض فقرات الدليل التوعوي */}
              ...
              {/* صندوق إخلاء المسؤولية القانوني أسفل جسم المقال */}
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 mt-10 non-prose">
                <p className="text-[11px] sm:text-xs text-slate-500 leading-relaxed m-0 font-medium">
                  <strong className="text-slate-700">⚠️ Disclaimer:</strong> This guide provides general information only and is not tax advice. Consult a qualified tax professional or CPA for advice specific to your situation.
                </p>
              </div>
            </div>
          </article>
          ...
          <aside className="space-y-6 lg:sticky lg:top-24">
            ...
            {/* صندوق الأدلة المقترحة الموصى بها */}
            ...
            <div className="bg-slate-100/80 border border-slate-200/40 rounded-2xl p-5 space-y-2">
              ...
              <a 
                href="https://irs.gov/pub/irs-pdf/p915.pdf" 
                target="_blank" 
