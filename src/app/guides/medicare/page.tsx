import { ArrowLeft, BookOpen, Calculator, ChevronRight, ShieldAlert, HeartPulse, ExternalLink, Phone, Calendar, Clock, UserCheck } from "lucide-react"
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.socialsecurityguidecalc.com/guides/medicare",
  },
  openGraph: {
    title: "Medicare Complete Guide 2026: Parts A, B, C, and D Explained",
    description: "Detailed breakdown of Medicare coverage, deductibles, premiums, and enrollment rules for 2026.",
    url: "https://www.socialsecurityguidecalc.com/guides/medicare",
    type: "article",
...
const medicareParts = [
  ...
  { part: "Part B", name: "Medical Insurance", color: "bg-amber-50/80 border-amber-100", textColor: "text-amber-900", desc: "Doctor visits, outpatient care, preventive services", cost: "$202.90/month (2026)" },
...
const sections = [
  ...
  },
  {
    ...
    content: "Part A covers inpatient hospital stays, care in a skilled nursing facility, hospice care, and some home health care. Most people do not pay a monthly premium for Part A if they or their spouse worked and paid Medicare taxes for at least 10 years (40 quarters). In 2026, the Part A inpatient hospital deductible is $1,736 per benefit period."
  },
  {
    id: "medicare-part-b",
    title: "Medicare Part B — Medical Insurance",
    content: "Part B covers doctor visits, outpatient care, preventive services, and medical equipment. The standard 2026 premium is $202.90 per month, deducted automatically from your Social Security check. Higher-income enrollees pay more through IRMAA surcharges. The 2026 annual deductible is $283. After meeting the deductible, you typically pay 20% of the Medicare-approved amount for most services."
  },
  {
    id: "medicare-part-c",
  ...
  {
    id: "costs-at-a-glance",
    title: "2026 Medicare Costs at a Glance",
    content: "Part A premium: $0 for most people. Part A deductible: $1,736 per benefit period. Part B premium: $202.90 per month standard. Part B deductible: $283 per year. Part D deductible: up to $615 per year. Out-of-pocket maximum for Medicare Advantage: $9,350 in-network (2026 limit)."
  },
  {
    id: "key-takeaways",
    title: "Key Takeaways",
...
export default function MedicareGuidePage() {
  ...
  // Comprehensive Schema for Google Rich Results (Article + MedicalWebPage + FAQPage + Breadcrumbs)
  const jsonLd = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "MedicalWebPage",
        "@id": `${baseUrl}/guides/medicare#webpage`,
        "url": `${baseUrl}/guides/medicare`,
        "name": "Medicare Complete Guide 2026: Parts A, B, C, and D Explained",
        "description": "Comprehensive guide covering Medicare Part A, Part B, Part C, and Part D costs, deductibles, and enrollment windows for 2026.",
        "author": {
          "@type": "Person",
          "name": "Amine Saadi",
          "url": baseUrl
      ...
      {
        "@type": "FAQPage",
        "@id": `${baseUrl}/guides/medicare#faq`,
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the Medicare Part B standard premium in 2026?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "The standard Medicare Part B monthly premium in 2026 is $202.90, with an annual deductible of $283."
            }
          },
          {
            "@type": "Question",
            "name": "When does the Medicare Initial Enrollment Period (IEP) start?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Your Initial Enrollment Period begins 3 months before the month you turn 65, includes your birthday month, and ends 3 months after — lasting 7 months in total."
            }
          },
          {
            "@type": "Question",
            "name": "What is the 2026 Medicare Part A hospital deductible?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "In 2026, the Medicare Part A inpatient hospital deductible is $1,736 per benefit period."
            }
          }
        ]
      },
      {
        "@type": "BreadcrumbList",
        "@id": `${baseUrl}/guides/medicare#breadcrumb`,
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
      ...
      <header className="bg-gradient-to-br from-[#071530] via-[#0b2045] to-[#102e60] py-14 text-white">
        <div className="container-site max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-wrap items-center gap-4 text-slate-400 text-[11px] sm:text-xs font-medium tracking-wide mt-6 border-t border-white/10 pt-4">
            ...
            <span className="flex items-center gap-1">
              <Clock size={13} className="text-slate-400" /> 20 min read
            </span>
          </div>
        </div>
      </header>
      ...
      <div className="container-site max-w-5xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <aside className="space-y-6 lg:sticky lg:top-24">
            ...
            {/* Medicare Calculator CTA Widget */}
            ...
            {/* Official Medicare Resources Box */}
